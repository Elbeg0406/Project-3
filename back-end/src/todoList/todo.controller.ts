import { Body, Controller, Get, Post, Put, Delete, Param, Res, HttpCode, HttpStatus } from '@nestjs/common';
...
export class ToDoController {
  ...
  @Put("/:id")
  public async updateOne(@Param("id") id:number, @Body() updateToDoRequest: UpdateToDoDto){
